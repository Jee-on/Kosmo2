...
public class BoardRec
{
	...
	public BoardRec( int groupId, String sequenceNo, String postingDate, int readCount, String writerName, String password, String title,  String content )
	{
